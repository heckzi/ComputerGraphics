...
//
//	//태양 그리기
//	if(light_state ==1) glLightfv(GL_LIGHT0, GL_POSITION, light_position);//태양의 중심에 광원위치하게
...
//	if (light_state == 2) glLightfv(GL_LIGHT0, GL_POSITION, light_position); //지구의 중심에 광원위치하게
//	glColor3f(0, 0.1, 0.9);
...
//	if (light_state == 3) glLightfv(GL_LIGHT0, GL_POSITION, light_position);  //달의 중심에 광원위치하게
//	glColor3f(0, 0.5, 1);
